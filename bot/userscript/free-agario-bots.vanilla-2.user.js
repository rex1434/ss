...
window.connection = {
    ...
    onopen() {
        ...
        document.getElementById('i-bar-bots2').style.background = '#00FF7F'
    ...
    onmessage(message) {
        ...
        switch (dataView.getUint8(0)) {
            case 0:
                ...
                document.getElementById('i-bar-bots1').style.background = '#00FF7F'
                document.getElementById('stopBots').disabled = false
            ...
            case 1:
                ...
                swal("Please Wait", "30 Seconds", "warning");console.log('Stopping Bots Server');$('#stopBots')
                document.getElementById('stopBots').innerText = 'Stopping Bots...'
                break
            case 2:
                document.getElementById('botsAI').style.color = '#DA0A00'
                document.getElementById('i-bar-bots3').style.background = '#DA0A00'
    ...
    onclose() {
        ...
        document.getElementById('userStatus').innerText = 'OFF'
        document.getElementById('botsAI').style.color = '#DA0A00'
        document.getElementById('i-bar-bots3').style.background = '#DA0A00'
        document.getElementById('botsAI').innerText = 'OFF'
                ...
                case options.hotkeys["BOTS_AI_KEY"].keycode:
                    if (window.user.startedBots && window.user.isAlive) {
                        if (!window.bots.ai) {
                            ...
                            document.getElementById('i-bar-bots3').style.background = '#00FF7F'
...
#i-bar-bots1, #i-bar-bots2, #i-bar-bots3 {
	width:0%;
	height:27px;
...
function loadUI(){
 $('body').append(`<div style="margin-left: 150px;"><div class="i-col" style="width: 150px; margin-top: 7.5px; padding: 1px;"><b><span>INFINI</span>TYBOTS</b></div><div class="i-col"> <div class="i-box"><div class="i-content"><div class="i-row"></div><div id="i-alive" class="i-row"> Minions </div> </div><div id="botCount">Waiting</div><div class="i-bar-back"><div id="i-bar-bots1" style="width: 100%; background-color: #DA0A00;"></div></div></div></div><div class="i-col"><div class="i-box"><div class="i-content"><div class="i-row"></div><div id="i-alive" class="i-row"> Server </div> </div><div id="userStatus">Waiting</div><div class="i-bar-back"><div id="i-bar-bots2" style="width: 100%; background-color: #DA0A00;"></div></div></div></div><div class="i-col"><div class="i-box"> <div class="i-content"><div class="i-row"></div><div id="i-alive" class="i-row"> Bots AI </div> </div> <div id="botsAI">Waiting</div><div class="i-bar-back"><div id="i-bar-bots3" style="width: 100%; background-color: #DA0A00;"></div></div></div></div></div>`);
}
